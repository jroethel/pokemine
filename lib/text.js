...
// Tweak here: bands are [floor, ceiling]; odds are absolute (sum = 20%).
const STAGES = {
  hp:  { 1: [30, 120], 2: [60, 160], 3: [90, 200] },   // [floor, ceiling]
  dmg: { 1: [10, 60],  2: [30, 120], 3: [60, 200] },
  special: {
    odds: { VMAX: 0.12, EX: 0.1, Mega: 0.08 },      // absolute, sums to 20%; VMAX < EX < Mega
...
// The 20% jackpot: only the evolution INTO stage 3 rolls; result is stored on the stage.
