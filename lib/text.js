...
const STAGES = {
  ...
  special: {
    ...
    variants: { // floors guarantee a special always out-stats a normal stage 3
      EX:   { hpMin: 220, hpMax: 260, dmgMin: 220, dmgMax: 260, label: 'EX',   art: 'crackling electric-blue energy, radiant silver aura, sparks flying' },
      DX:   { hpMin: 240, hpMax: 300, dmgMin: 240, dmgMax: 300, label: 'DX',   art: 'wreathed in golden fire, glowing prismatic divine radiance' },
      Mega: { hpMin: 260, hpMax: 340, dmgMin: 260, dmgMax: 340, label: 'MEGA', art: 'colossal mega-evolved form, swirling cosmic nebula background, rainbow prismatic aura, glowing mega stone on its brow' },
    },
  },
};
