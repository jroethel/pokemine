...
Invent their profile. Reply with JSON:
{"region": "their home region (canon or invented)", "homeGym": "their home gym: town + gym type, e.g. 'Vermilion City Electric Gym'", "backstory": "3-5 sentence fun trainer origin story that mentions the region and home gym"}`);
    for (const k of ['region', 'homeGym', 'backstory']) {
